...
export const set6: Question[] = [
    ...
    {
        "id": 57,
        "question": "Tiêu chuẩn đánh giá về vật tư được yêu cầu về nhãn hiệu theo nhóm nhãn hiệu cho nguyên nhiên vật liệu, vật tư và các yếu tố đầu vào đối với trường hợp nào?",
        "options": {
